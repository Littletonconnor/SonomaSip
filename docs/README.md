...
| Document                       | Purpose                                                                                          |
| ------------------------------ | ------------------------------------------------------------------------------------------------ |
| [**PRD.md**](./PRD.md)         | Formal product requirements: users, scope, flows, policies, metrics—**no implementation stack**. |
| [**SCORING.md**](./SCORING.md) | Matching rules, weights, and examples (create with engineering).                                 |
