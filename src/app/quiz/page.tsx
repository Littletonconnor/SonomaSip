  ...
  return (
    <main className="flex flex-1 flex-col items-center justify-center px-6 py-24">
      ...
      <p className="text-muted-foreground mt-4 max-w-md text-center">
        The personalized winery quiz is being built. You&apos;ll answer a few quick questions about
        varietals, vibe, budget, and group needs — then get a ranked list of matches.
      </p>
